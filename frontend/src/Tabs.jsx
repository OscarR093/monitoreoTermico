...
const TabsComponent = ({ onLogout, user }) => {
  ...
  return (
    <div className='flex flex-col h-screen font-sans bg-gray-100 text-gray-800'>
      ...
      <div className={`fixed inset-0 bg-black bg-opacity-50 z-40 transition-opacity md:hidden ${tabsMenuOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`} onClick={toggleTabsMenu} />
